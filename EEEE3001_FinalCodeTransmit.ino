...
#define IMU_PORT 2
#define FLEX_RING_PORT 7
#define FLEX_MIDDLE_PORT 5
#define FLEX_INDEX_PORT 3
...
typedef struct {
  ...
  float stretch[3];  // Index 0=Index, 1=Middle, 2=Ring
...
void loop() {
  // --- 10 Second Timer Packet Count Test ---
  ...
  if (millis() >= 10000) {
    if (!testComplete) {
      ...
      Serial.print("  Final Packets Sent: ");
      Serial.println(data.seqNum);
  ...
  Serial.print("SeqNum:");  Serial.print(data.seqNum);   Serial.print(" ");
